...
export default function Lessons() {
  ...
  const lessonsContents = [
    {
      imageUrl: "/web3100_final_project/assets/img/victoire-joncheray-EF0UG0xFgnA-unsplash.jpg",
      textContent:
    ...
    {
      imageUrl: "/web3100_final_project/assets/img/ben-koorengevel-QtyErb_h4PU-unsplash.jpg",
      textContent:
    ...
    {
      imageUrl: "/web3100_final_project/assets/img/nejc-peternelj-SCXuSA6-Szg-unsplash.jpg",
      textContent:
      ...
      <div className="xl:px-64">
        ...
        <>
          <div className="flex item-center mt-8">
            ...
            <img src="/web3100_final_project/assets/img/Chevron right.png" alt="" className="w-10 h-10"/>
